...
import pxlMod.cards.*;
import pxlMod.relics.Satanic_Pact;

import java.util.ArrayList;

import static pxlMod.BasicMod.characterPath;
import static pxlMod.BasicMod.makeID;

public class Heretic extends CustomPlayer {
    //Stats
    public static final int ENERGY_PER_TURN = 3;
    public static final int MAX_HP = 63;
    public static final int STARTING_GOLD = 99;
    public static final int CARD_DRAW = 5;
    public static final int ORB_SLOTS = 0;

    //Strings
    private static final String ID = makeID("Heretic"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Meta {
        ...
        @SpireEnum
        public static PlayerClass HERETIC;
        @SpireEnum(name = "HERETIC_YELLOW_COLOUR") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "HERETIC_YELLOW_COLOUR") @SuppressWarnings("unused")
        ...
        public static void registerCharacter() {
            BaseMod.addCharacter(new Heretic(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }
    ...
    public ArrayList<String> getStartingDeck() {
        ...
        retVal.add(Defend.ID);
        retVal.add(Defend.ID);
        retVal.add(Etched_Dagger.ID);
        retVal.add(Unholy_Sermon.ID);

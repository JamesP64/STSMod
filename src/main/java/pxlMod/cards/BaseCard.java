...
import pxlMod.BasicMod;
import pxlMod.util.CardStats;
import pxlMod.util.TriFunction;
...
import static pxlMod.util.GeneralUtils.removePrefix;
import static pxlMod.util.TextureLoader.getCardTextureString;
